<template>
<div class="water">
<div class="inner-header position-flex">
    <div class="max-w-3xl mx-auto px-5 mt-10 mb-3">
    <div class="flex flex-col justify-center">
        ...
        <div class="flex flex-wrap items-center justify-center gap-10 mt-2 md:justify-around">
            ...
            <div class="text-gray-400 ">
                <svg viewBox="0 0 248 31" class="w-auto h-5 text-slate-900 ">
...
.position-flex { /*Flexbox for containers*/
  display: flex;
