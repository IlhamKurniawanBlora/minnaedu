<template>
    <!-- component -->
<section id="pelajaran" class="py-10 relative bg-white sm:py-16 lg:py-24 lg:pt-36">
...
const pelajarans = ref<Pelajaran[]>([
  {
    name: 'Matematika'
  },
  {
